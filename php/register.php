					...
					<div class="row">
						<div class="logContainer">
							<form action="registration.php" method="POST">
								...
								<div class="form-group">
									<label class="labelForm">Répéter le mot de passe :</label>
									<br>
									<input class="inputForm" type="password" name="redo_password" placeholder="saisir votre mot de passe une autre fois" class="form-control" required>
								</div>
								<button class="formBTN" type="submit" class="btn btn-primary"> S'inscrire </button>
								<br>
							</form>
							<button class="switchFormBTN" onClick="goToLogin();"> Vous avez déja un compte ? connectez-vous </button>
						</div>
					</div>
				</div>
			<!-- end login form -->
